...
$mainImg = $img->crop(1647, 873, 240, 0)->save("$rootDir/Клинкер/$paletteName/aside/$asideName.jpg", 100, 'jpg');
$previewImg = $img->resize(494, 262)->save("$rootDir/Клинкер/$paletteName/aside/$asideName preview.jpg", 100, 'jpg');
$previewWebp = $img->save("$rootDir/Клинкер/$paletteName/aside/$asideName preview.webp", 100, 'webp');
$palette = $img->crop(352, 253, 0, 6)->resize(70, 50)->save("$rootDir/Клинкер/$paletteName/palette/palette-$asideName.png", 100, 'png');
$palette = $img->save("$rootDir/Клинкер/$paletteName/palette/palette-$asideName.webp", 100, 'webp');
$result = [
    "variants" => ["$path/Клинкер/$paletteName/aside/$asideName.jpg"],
    "previews" => [
        "jpg" => "$path/Клинкер/$paletteName/aside/$asideName preview.jpg?" . filemtime("$rootDir/Клинкер/$paletteName/aside/$asideName preview.jpg"),
        "webp" => "$path/Клинкер/$paletteName/aside/$asideName preview.webp"
    ],
    "palette" => [
